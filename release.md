...
- **Smidigare AI-assistent med Claude Code** — AI-arbetsytan godkänner nu automatiskt de skrivskyddade bokföringsuppslag som Claude Code använder, så att exempelvis konton, saldon och verifikationer kan läsas utan en bekräftelse för varje anrop. Åtgärder som ändrar data, importerar eller exporterar kräver fortfarande uttryckligt godkännande. Befintliga egna behörigheter behålls och inställningsfilen skyddas mot symboliska länkar. Tillfälliga hemligheter i AI-arbetsytan rensas när programmet startar och avslutas, samt innan MCP-token återställs. AI-arbetsytan heter nu `alipsa-accounting-ai-assistant`, vilket också ger Codex ett tydligare projektnamn, och Claude Code startar med namnet ”Alipsa Accounting AI Assistant”.
...
- **Tydligare hantering av räkenskapsår** — Att skapa ett räkenskapsår öppnar nu en dialog för namn och datum i stället för att visa fälten permanent. Ett öppet räkenskapsår kan stängas direkt från listan, medan Årsbokslut fortfarande används när bokslutsposter ska skapas. Det går inte att skapa ett senare räkenskapsår innan det närmast föregående har stängts.
