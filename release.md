...
- **Smidigare AI-assistent med Claude Code** — AI-arbetsytan godkänner nu automatiskt de skrivskyddade bokföringsuppslag som Claude Code använder, så att exempelvis konton, saldon och verifikationer kan läsas utan en bekräftelse för varje anrop. Åtgärder som ändrar data, importerar eller exporterar kräver fortfarande uttryckligt godkännande. Befintliga egna behörigheter behålls och inställningsfilen skyddas mot symboliska länkar. AI-arbetsytan heter nu `alipsa-accounting-ai-assistant`, vilket också ger Codex ett tydligare projektnamn, och Claude Code startar med namnet ”Alipsa Accounting AI Assistant”.
