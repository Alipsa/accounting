...
Efter att bevarandetiden har löpt ut tar radering av räkenskapsår bort både databasrader och
lagrade filer för bilagor och rapportarkiv. Databasrader raderas transaktionellt först; filerna
raderas därefter som ett kontrollerat uppföljningssteg där eventuella misslyckanden rapporteras
för manuell städning.

Audit-loggposter som pekar på det raderade räkenskapsåret, dess perioder, verifikationer,
momsperioder eller bilagor raderas permanent. De arkiveras inte i permanent-delete-flödet.
Kvarvarande audit-loggkedja byggs om så att integritetskontrollen fortfarande kan verifiera
de kvarvarande raderna.

Företagsradering är endast tillåten när inga räkenskapsår finns kvar. När spärren passerats
raderas kvarvarande företagskopplad metadata som inte längre representerar bokföringsår,
till exempel audit-kedjehuvud, importjobb och kontoplan.
